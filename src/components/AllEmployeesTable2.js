...
const ToolbarHeader = ({ title, add_Employee }) => {
  const classes = useToolbarStyles();
    ...
    <div>
      <Toolbar>
        ...
        <Tooltip title="add record">
          <IconButton aria-label="filter list" onClick={add_Employee}>
...
export default function AllEmployeesTable({ title, headCells }) {
  ...
  const update_Employee = async (id) => {
  ...
  return (
    <>
      <ToolbarHeader title="All Employees" add_Employee={add_Employee} />
                      ...
                      >
                        ...
                        <div>
                          ...
                          <TableCell align="right">
                            <DeleteIcon
                              color="primary"
                              onClick={() => delete_Employee(row.id)}
                            />
                          </TableCell>
                        </div>
                      </TableRow>
